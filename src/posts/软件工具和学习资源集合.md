...
mySlug: applications and learning sources
tags:
  - apps
description: 整理众多操作系统下实用的软件工具和学习资源
---

[Awesome Tools](https://github.com/byodian/awesometools) 整理众多操作系统下实用的软件工具和学习资源，项目灵感来源于 [Awesome macOS](https://github.com/iCHAIT/awesome-macOS 'Awesome macOS')、[Awesome](https://github.com/Awesome-Windows/Awesome.git)、[Windows 绝赞应用](https://amazing-apps.gitbook.io/windows-apps-that-amaze-us/zh-cn)。
